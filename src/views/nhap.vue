<template>
  <div class="goiso">
    <div class="so-group">
      ...
      <div class="so-item" :class="{ blinking: blinkThuong }">
        Số thường: <strong v-if="soThuong !== null">{{ soThuong }}</strong>
      </div>
      <div class="so-item" :class="{ blinking: blinkUuTien }">
    ...
    <div class="btn-group">
      ...
      <button class="btn btn-warning" title="Gọi ưu tiên" @click="goiUuTien">
        <span class="material-symbols-outlined">star</span>
      </button>
      <button class="btn btn-blue" title="Gọi thường" @click="goiThuong">
    ...
    <div v-if="open" class="modal-container">
      ...
      <div class="modal-content">
        ...
        <label>Số quầy:</label>
        <input type="number" v-model.number="quay" min="1" class="form-input" />
